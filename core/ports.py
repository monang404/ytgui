...
class TrackRepositoryPort(Protocol):
    ...
    async def close(self) -> None: ...
    async def upsert_track(self, track: TrackInfo, stream_url: Optional[str] = None) -> None: ...
    async def update_stream_url_only(self, video_id: str, stream_url: str) -> None: ...
    async def get_track(self, video_id: str) -> Optional[Dict[str, Any]]: ...
    async def add_history(self, video_id: str) -> None: ...
